...
// Auxiliary functions for gamma correction (sRGB <-> Linear)
// Converts a channel from sRGB to linear RGB
...
// Convert a vector from sRGB to linear RGB
...
// Convert a linear RGB vector to sRGB
...
// ----- MAIN FUNCTION OF RGB CONVERSION -> OKLAB -----
...
// ----- MAIN CONVERSION FUNCTION OKLAB -> RGB -----
