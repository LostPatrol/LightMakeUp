...
#if defined CLOUD_REFLECTION && (!defined UNKNOWN_DIM) && !defined NETHER
...
void main() {
    ...
    #if SHADOW_TYPE == 1 || (defined CLOUD_REFLECTION && (!defined UNKNOWN_DIM) && !defined NETHER) || SSR_TYPE > 0
