...
// Candles color and intensity
// --- OPTIMIZATION #1: Replace pow(x, 1.5) with x * sqrt(x) ---
...
// --- OPTIMIZATION #2: Avoid length() in the conditional ---
...
// Direct light strenght --
    ...
    // --- CORRECTION: The variable is declared and calculated here, outside the if/else ---
    // This ensures that ‘far_direct_light_strength’ is always available after this block.
    ...
    // Now, the if/else logic only modifies ‘direct_light_strength’ and ‘omni_strength’.
...
// --- OPTIMIZATION #3: Prevent division by zero ---
